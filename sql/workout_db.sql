...
CREATE TABLE movements (
  ...
  primary_muscles ENUM('abdominals','hamstrings','adductors','quadriceps','biceps','shoulders','chest','middle back','calves','glutes','lower back','lats','triceps','traps','forearms','neck','abductors') DEFAULT NULL,
  secondary_muscles ENUM('abdominals','hamstrings','adductors','quadriceps','biceps','shoulders','chest','middle back','calves','glutes','lower back','lats','triceps','traps','forearms','neck','abductors') DEFAULT NULL,
  focus ENUM('pull', 'push', 'static') DEFAULT NULL,
  level ENUM('beginner', 'intermediate', 'expert') DEFAULT NULL,
  mechanic ENUM('compound', 'isolation') DEFAULT NULL,
  ...
  category ENUM('strength', 'stretching', 'plyometrics', 'strongman', 'powerlifting', 'cardio', 'olympic weightlifting') DEFAULT NULL,
